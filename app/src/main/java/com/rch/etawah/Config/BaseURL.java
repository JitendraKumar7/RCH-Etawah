package com.rch.etawah.Config;


public class BaseURL {
    static final String APP_NAME = "GoGrocer";
    public static final String MyPrefreance = "com.rch.etawah";
    ...
    public static String BASE_URL = "http://app.rchetawah.com/api/";
    public static String IMG_URL = "http://app.rchetawah.com/";
    public static String BANN_IMG_URL = "http://app.rchetawah.com/";
    ...
    public static String Add_address = BASE_URL + "AddAddressActivity";
    ...
    public static String ADD_ADDRESS_URL = BASE_URL + "index.php/api/AddAddressActivity";
